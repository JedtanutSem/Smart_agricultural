...
def PoseSaver_CLBK(data):
    ...
    """
    Cira core must send state that is available for position saved and
    send the number for specific postion
    """
...
def PoseSaveListen_Trig():
    ...
    rospy.Subscriber("/robot/position", Robotpose, Robotpose_CLBK) #Subscribe current robot position from tf_map_robot
